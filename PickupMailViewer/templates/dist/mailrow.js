...
this["mailviewer"]["handlebars"]["templates"]["mailrow"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "<tr class=\"message-row"
    ...
    + "\" data-mail-id=\""
    + alias3(((helper = (helper = helpers.MessageId || (depth0 != null ? depth0.MessageId : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"MessageId","hash":{},"data":data}) : helper)))
    + "\">\r\n    <td>\r\n"
    ...
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.AttachmentNames : depth0),{"name":"if","hash":{},"fn":this.program(7, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "    </td>\r\n    <td>\r\n        "
